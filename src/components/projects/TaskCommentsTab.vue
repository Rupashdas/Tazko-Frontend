...
const confirmDeleteComment = async () => {
	deleting.value = true
	const result = await store.deleteComment(props.projectId, props.taskId, deletingCommentId.value)
...
const toggleLike = (commentId) => {
	store.toggleLike(props.projectId, props.taskId, commentId)
}
</script>
	...
	<div class="p-5">
		<div class="max-w-3xl mx-auto">
			...
			<div class="flex items-center gap-2 mb-5">
				...
				<h3 class="text-base font-bold text-heading">Task Discussion</h3>
